...
void SpinQuant_Decoding(
    ...
    tapa::mmaps<hls::vector<ap_int<8>, DEC_QKVO_FFN_W_PARALLEL/2>, T_QKVO_FFN_BLOCK_PARALLEL/2> w_qkvo_FFN_mmaps_half_0,
    tapa::mmaps<hls::vector<ap_int<8>, DEC_QKVO_FFN_W_PARALLEL/2>, T_QKVO_FFN_BLOCK_PARALLEL/2> w_qkvo_FFN_mmaps_half_1,
