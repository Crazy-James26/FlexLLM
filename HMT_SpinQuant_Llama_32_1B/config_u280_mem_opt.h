...
#define sqrt_HIDDEN_DIM 45.2548339959
...
//HMT config
#define HMT_MAX_SEG_NUM 64
#define HMT_SEG_LEN 990
#define HMT_SUM_SEG_LEN 495
#define HMT_REC_SEG_LEN 32
#define MEM_NUM 64

constexpr int HMT_T_BLOCK_PARALLEL = 4;
constexpr int  HMT_W_QK_ATTN_PARALLEL = 8;
