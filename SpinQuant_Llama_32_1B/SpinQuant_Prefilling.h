...
void pref_weight_loader_w_ffn_gate(
    ...
    decoder_block_loop: for (int block_id = 0; block_id < DECODER_LAYER_NUM; block_id++){
        pref_weight_loader_int4_pack_2_discard<PRE_FFN_W_PARALLEL_READ, PRE_FFN_W_PARALLEL, TOKEN_PARALLEL, HIDDEN_DIM, INTER_DIM>(
            w_ffn_gate_mmap, w_ffn_gate_stream, block_id, seq_len, HIDDEN_DIM, INTER_DIM
        );
    }
}
...
void pref_Linear_Layer_i4xi4_ffn_gate(
    ...
    decoder_block_loop: for (int block_id = 0; block_id < DECODER_LAYER_NUM; block_id++){
        pref_Linear_Layer_i4xi4<TOKEN_PARALLEL, PRE_FFN_W_PARALLEL, HIDDEN_DIM, log2_HIDDEN_DIM, INTER_DIM, MAX_PRE_SEQ_LEN, true>(
            input_stream_ffn_gate, w_ffn_gate_stream, output_stream_ffn_gate, seq_len, HIDDEN_DIM, INTER_DIM
        );
...
void pref_weight_loader_w_ffn_up(
    ...
    decoder_block_loop: for (int block_id = 0; block_id < DECODER_LAYER_NUM; block_id++){
        pref_weight_loader_int4_pack_2_discard<PRE_FFN_W_PARALLEL_READ, PRE_FFN_W_PARALLEL, TOKEN_PARALLEL, HIDDEN_DIM, INTER_DIM>(
            w_ffn_up_mmap, w_ffn_up_stream, block_id, seq_len, HIDDEN_DIM, INTER_DIM
        );
    }
}
...
void pref_Linear_Layer_i4xi4_ffn_up(
    ...
    decoder_block_loop: for (int block_id = 0; block_id < DECODER_LAYER_NUM; block_id++){
        pref_Linear_Layer_i4xi4<TOKEN_PARALLEL, PRE_FFN_W_PARALLEL, HIDDEN_DIM, log2_HIDDEN_DIM, INTER_DIM, MAX_PRE_SEQ_LEN, true>(
            input_stream_ffn_up, w_ffn_up_stream, output_stream_ffn_up, seq_len, HIDDEN_DIM, INTER_DIM
        );
...
void pref_weight_loader_w_ffn_down(
    ...
    decoder_block_loop: for (int block_id = 0; block_id < DECODER_LAYER_NUM; block_id++){
        pref_weight_loader_int4_pack_2_discard<PRE_FFN_W_PARALLEL_READ, PRE_FFN_W_PARALLEL, TOKEN_PARALLEL, INTER_DIM, HIDDEN_DIM>(
            w_ffn_down_mmap, w_ffn_down_stream, block_id, seq_len, INTER_DIM, HIDDEN_DIM
        );
    }
}
...
void pref_Linear_Layer_i4xi4_ffn_down(
    ...
    decoder_block_loop: for (int block_id = 0; block_id < DECODER_LAYER_NUM; block_id++){
        pref_Linear_Layer_i4xi4<TOKEN_PARALLEL, PRE_FFN_W_PARALLEL, INTER_DIM, log2_INTER_DIM, HIDDEN_DIM, MAX_PRE_SEQ_LEN, true>(
            input_stream_ffn_down, w_ffn_down_stream, output_stream_ffn_down, seq_len, INTER_DIM, HIDDEN_DIM
        );
...
void SpinQuant_Prefilling(
    ...
    .invoke(pref_weight_loader_w_ffn_gate, w_ffn_gate_mmap, w_ffn_gate_stream, seq_len)
    .invoke(pref_weight_s_loader_w_ffn_gate, w_ffn_gate_s_sum_mmap, w_ffn_gate_s_sum_stream, seq_len)
    .invoke(pref_Linear_Layer_i4xi4_ffn_gate, quant_ln_res0_stream_ffn_gate, w_ffn_gate_stream, quant_ffn_gate_stream, seq_len)
    // .invoke(pref_Linear_Layer_i4xi4_ffn_gate, quant_ln_res0_stream_ffn_gate, w_ffn_gate_stream, quant_ffn_gate_stream_redundant, seq_len)
    ...
    .invoke(pref_weight_loader_w_ffn_up, w_ffn_up_mmap, w_ffn_up_stream, seq_len)
    .invoke(pref_weight_s_loader_w_ffn_up, w_ffn_up_s_sum_mmap, w_ffn_up_s_sum_stream, seq_len)
    .invoke(pref_Linear_Layer_i4xi4_ffn_up, quant_ln_res0_stream_ffn_up, w_ffn_up_stream, quant_ffn_up_stream, seq_len)
    // .invoke(pref_Linear_Layer_i4xi4_ffn_up, quant_ln_res0_stream_ffn_up, w_ffn_up_stream, quant_ffn_up_stream_redundant, seq_len)
    ...
    .invoke(pref_weight_loader_w_ffn_down, w_ffn_down_mmap, w_ffn_down_stream, seq_len)
    .invoke(pref_weight_s_loader_w_ffn_down, w_ffn_down_s_sum_mmap, w_ffn_down_s_sum_stream, seq_len)
    .invoke(pref_Linear_Layer_i4xi4_ffn_down, quant_r4_gated_sw_ffn_up_stream, w_ffn_down_stream, quant_ffn_down_stream, seq_len)
    // .invoke(pref_Linear_Layer_i4xi4_ffn_down, quant_r4_gated_sw_ffn_up_stream, w_ffn_down_stream, quant_ffn_down_stream_redundant, seq_len)
